...
<nav class="navbar navbar-header navbar-expand navbar-light sticky-top">
    ...
    <div style="padding-top: 10px;padding-left: 15px">
        <h5 class="text-muted">DGPC Compact System</h5>
    </div>
                ...
                <a href="#" data-bs-toggle="dropdown"
                   class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                    <div class="d-lg-inline-blocks">
                        <i data-feather="bell" class="notificationBell"></i>
            ...
            <li class="dropdown">
                <a href="#" data-bs-toggle="dropdown"
                   class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                    ...
                    <div class="d-none d-md-block d-lg-inline-block">${currentUser.fullName}</div>
                </a>
                <div class="dropdown-menu dropdown-menu-end square"
                     style="padding-top: 0px !important;padding-bottom: 0px;padding-left: 0px; border: 1px solid #0a98fb !important; ">
                    <div style="width: 250px !important;">
                        <div class="square"
                             style="background: linear-gradient(to bottom, #0a98fb, #eff4f4); ">
